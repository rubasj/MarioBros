...
const KOOPA_FULL_COLLISION_SHAPE = preload("res://resources/koopa_full_collision_shape.tres")
const KOOPA_SHELL_COLLISION_SHAPE = preload("res://resources/koopa_shall_collision_shape.tres")
